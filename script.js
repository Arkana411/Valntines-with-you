...
const prompts = [
    "Ayang beneyan huhu?",
    "Cukup tau ciiiii??",
    "Ihhhhhhh parah sih ayangg?",
    "Ayang pleasee pilih yes dongs huftt...",
    "Coba dipikirin lagi ntr nyesel lochhhh!",
    "Kalau ayang pilih No teyus acuu ngambek bialin huhuhu",
    "Acu cedih huhuhu...",
    "HFIDS ACUU BENEYAN CEDIH HUHUHU",
    "Ok fine huftt",
